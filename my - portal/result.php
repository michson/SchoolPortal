                    ...
                    <table style="width:100%" cellspacing="0" cellpadding="3" border="0">
                        <div class="section-title row text-center"> 
                            <div><!-- I started content here -->
                            	<center><h4 style="color: darkgreen; font-weight: bolder; font-size: larger;">My Result</h4></center>
                                <table border="3" cellpadding="3px" width="130%">
                                    <tr>
                                        <td colspan="18" style="text-align: center; font-weight: bold; color: darkgreen">FIRST SEMESTER</td>
                                    </tr>
                                    <tr>
                                        <th>COM111</th>
                                        <th>GRADE</th>
