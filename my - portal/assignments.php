                    ...
                    <table style="width:100%" cellspacing="0" cellpadding="3" border="0">
                        <div class="section-title row text-center"> 
                            <div><!-- I started content here -->
                            	<center><h4 style="color: darkgreen; font-weight: bolder; font-size: larger;">My Assignments</h4></center>
                                <font>To view your Assignment you need to click download button.<br><span style="font-weight: bold; color: red">NOTE: Follow the instructions as you have been given.</span> </font>
                                <table cellpadding="3px" width="130%">
                                    <tr>
                                        <th>Course Code</th>
                                        <th>Course Title</th>
                                        <th>Assignments</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>Make it complex</td>
                                        <td>9:00am - 19/1/22</td>
                                    </tr>
                                </table>
                                <p>
                                    <br><br>
                                </p>
                                <form style="border-style: ridge; border-color: darkgreen; border-top-width: 12px; padding: 10px;">
                                    <p style="font-weight: bold; color: darkgreen">Submit your Assingment</p>
                                    <label>To:</label>
                                    <input type="email" name="">
                                    <label style="margin-left: 50px">Matric No.:</label>
                                    <input type="text" name=""><br><br>
                                    <label>Upload your Assignment</label><br>
