                ...
                <div style="padding:50px;overflow:auto;width:800px;height:800px">
                    <table style="width:100%" cellspacing="0" cellpadding="3" border="0">
                        <div class="section-title row text-center"> 
                            <div><!-- I started content here -->
                                <center><h4 style="color: darkgreen; font-weight: bolder; font-size: larger;">My Registration</h4></center>
                                <font>Register all your courses in the table below include the semester and session</font>
                                <table>
                                    <tr>
                                        <td>
                                <table style="width: 115%">
                                    <tr>
                                        ...
                                        <table border="1px" cellspacing="1px" cellpadding="1px" style="font-size: 12px">
                                           <tr>
                                            <td></td>
                                            <td>
                                                <label style="font-weight: bold;">Select Semester</label><br>
                                            ...
                                            <td>
                                                <label style="font-weight: bold;">Select Session</label><br>
                                                <select name="session">
                                                    <option>----</option>
                                                    <option>2018</option>
                                                    <option>2019</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>Introduction to Programming</td>
                                            <td align="center">
                                                <input type="checkbox" name="course2">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>COM 111</td>
                                    ...
                                    <td>
                                        <form action="registration.php" method="post" >    
                                        <table cellpadding="1px" style="font-size: 12px" border="">
                                           <tr>
                                            <td></td>
                                            <td>
                                                <label style="font-weight: bold;">Select Semester</label><br>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                        <form action="registration.php" method="post" >    
                                        <table cellpadding="1px" style="font-size: 12px" >
                                            <tr>
                                            <p>
                                                <br><br>
                                            </p>
                                            <p style="font-weight: bold; color: darkgreen">If you can find your course from the top table you can add new course below.</p>
                                            </tr>
                                            <tr>
                                            <td></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <label style="font-weight: bold;">Add new Course:</label>
                                                <br>
                                                <select>
                                                    <option>---select new course---</option>
                                                    <option>COM 112 Introduction to Web Development</option>
                                                    <option>COM 112 Introduction to Web Development</option>
                                                    <option>COM 112 Introduction to Web Development</option>
                                                    <option>COM 112 Introduction to Web Development</option>
                                                    <option>COM 112 Introduction to Web Development</option>
                                ...
                                <p style="color: darkgreen; font-size: 18px; font-weight: bold; text-align: center;">
                                    <br>
                                    Brief talk about registration of your course
                                </p>
