...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2022 at 05:52 PM
...
INSERT INTO `admin` (`fname`, `lname`, `usertype`, `id`, `username`, `password`) VALUES
('admin', 'admin', '', 1, 'admin', 'admingpo');
...
CREATE TABLE IF NOT EXISTS `biodata` (
  ...
  `apnum` varchar(100) DEFAULT NULL
...
INSERT INTO `biodata` (`id`, `name`, `surname`, `middlename`, `email`, `mstatus`, `gender`, `state`, `local`, `phone`, `address`, `dob`, `exam`, `course`, `adstatus`, `apnum`) VALUES
(NULL, 'Abdulwarith', 'Mustopha', 'Olayikanmi', 'mustophaabdulwareeth3918@gmail.com', 'single', 'Male', 'KWARA', 'Offa', '07059025507', 'No. Ijagbo Junction Ijagbo Kwara State', '2022-02-22', 'wassce private', 'Computer Science', 0, 'APPN/GPO/22208791'),
(NULL, 'Abdulwarith', 'Mustopha', 'Olayikanmi', 'mustophaabdulwareeth3918@gmail.com', 'single', 'Male', 'KWARA', 'Offa', '07059025507', 'No. F.5 Ijagbo Junction Ijagbo Kwara State ', '2022-02-25', 'wassce private', 'Computer Science', 0, 'APPN/GPO/22209051');
...
CREATE TABLE IF NOT EXISTS `examination` (
  ...
  `exam` text,
  `jambreg` text,
  `jambscore` varchar(255) DEFAULT NULL,
  `s1` text,
  `g1` text,
  `s2` text,
  `g2` text,
...
INSERT INTO `examination` (`id`, `exam`, `jambreg`, `jambscore`, `s1`, `g1`, `s2`, `g2`, `s3`, `g3`, `s4`, `g4`, `s5`, `g5`, `s6`, `g6`, `s7`, `g7`, `s8`, `g8`, `s9`, `g9`, `program`, `course`, `adstatus`, `apnum`) VALUES
(NULL, 'wassce private', '23444447GD', '400', 'English', 'A1', 'Mathematics', 'AB', 'Civic Education', 'AB', 'Marketing', 'C5', 's5', 'g5', 'Commerce', 'C4', 'Oral English', 'AB', 'Literature in English', 'B2', 'Animal Husbandary', 'AB', 'OND', 'Computer Science', 0, 'APPN/GPO/22208791'),
(NULL, 'wassce private', '12345678GB', '400', 'English', 'A1', 'Mathematics', 'A1', 'Government', 'A1', 'Further Maths', 'C5', 's5', 'g5', 'Finacial Account', 'B2', 'Computer Studies', 'C4', 'Civic Education', 'A1', 'Economics', 'A1', 'OND', 'Computer Science', 0, 'APPN/GPO/22209051');
...
CREATE TABLE IF NOT EXISTS `profile_images` (
  ...
  `apnum` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `profile_images` (`ID`, `imgname`, `apnum`) VALUES
(NULL, '657697744.jpg', 'APPN/GPO/22208791'),
(NULL, '1005996982.jpg', 'APPN/GPO/22209051');
...
`id` int(11) NOT NULL,
  ...
  `gmaritalstatus` varchar(255) NOT NULL,
  `gphoneeon` varchar(255) NOT NULL,
...
(2, 'mustech', 'mustophaabdulwareeth3918@gmail.com', '07059025507', '$2y$10$lO4kfdf8PpzJlwtCc13q1u5vTEIOX5TCjicwEPGOK21l/2xtyaiLq', '2022-03-01 07:08:06');
