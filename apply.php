...
<div class="form-row">
  ...
  <div class="col-md-4">
  <select type="select" name="state" id="middlename" class="form-control"  required>
...
<label class="control-label col-md-2 text-center text-danger">Phone:</label>
  <div class="col-md-4">
<input type="text" maxlength="11" onkeypress="javascript:return isNumber(event)" name="phone" id="phone" class="form-control" required />
...
<label class="control-label col-md-2 text-center text-danger">D.o.b:</label>
  <div class="col-md-4">
<input type="date" placeholder="dd/mm/yyyy" name="dob" id="dob" class="form-control" required />
<span id="dob-error" class="signup-error help-block"></span>
</div>
<div class="text-center col-md-2" id="img_contain">
  <img src="images/ghost_person.png" id="output" width="130" height="120" class="img img-responsive thumbnail">
</div>
...
<br>
<div style="float: center; margin-left: 50px; margin-right: 50px;">
