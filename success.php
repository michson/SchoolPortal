            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbars-host">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="admission.html">Admission</a></li>
...
<br>
        ...
        // session_start();
        ?>
<h1 class="text-success" align="center"> Congratulation </h1>
<h1 class="text-success" align="center">Dear <b><?php echo $_SESSION['surname'].' '.$_SESSION['name'] ?></b></h1>
<h3 class="text-success" align="center">Your Application Number Is:</h3>
<h3 class="text-success" align="center"><?php echo $_SESSION['appid']; ?></h3>
<h3 class="text-success" align="center"><b>NB:</b> Make sure you copy your Application Number</h3>
<center><a href="login-portal.php"><button class="btn btn-success">Click to Login</button></a></center> 
